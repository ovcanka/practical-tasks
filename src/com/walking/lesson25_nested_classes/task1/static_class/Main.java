...
import com.walking.lesson25_nested_classes.task1.static_class.EquilateralShape;
...
//        ради демонстрации ситуации, когда скобки в условном выражении действительно необходимы
    ...
    private static String createShapeString(int length, int type) {
        ...
        switch (type) {
            case 1:
                EquilateralShape.Square square = new EquilateralShape.Square(length);
                return EquilateralShape.Square.createShapeString();

            case 2:
                EquilateralShape.EquilateralTriangle triangle= new EquilateralShape.EquilateralTriangle(length);
